...
#date >> amb_data.dat
#echo "Tarekc" >> thermal_data.dat
# Print headers for data to data file
#echo -e "Frequency\tTemp\tPower\tAmb_out" >> amb_data.dat
...
amb_tmp=`python bjornAPI.py get_crac_out_temp`
sleep 25s
power_tmp=`python bjornAPI.py get_self_power`

echo -e "${freq_tmp}\t\t${temp_tmp}\t${power_tmp}\t${amb_tmp}"
